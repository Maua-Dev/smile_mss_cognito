...
from src.modules.check_token.app.check_token_presenter import lambda_handler
from src.shared.domain.entities.enums import ACCESS_LEVEL, ROLE


class Test_CheckTokenPresenter:
    def test_check_token_presenter(self):
    ...
    def test_check_token_presenter_invalid_token(self):
        ...
        event = {
            ...
            "headers": {
                "Authorization": "Bearer INVALID_access_token-zeeba@gmail.com",
            },
            "queryStringParameters": {
                "email": "zeeba@gmail.com"
            },
