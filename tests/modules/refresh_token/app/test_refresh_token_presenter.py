    ...
    def test_refresh_token_presenter(self):
        event = {
            ...
            "headers": {
                ...
                'Authorization': "Bearer valid_refresh_token-zeeba@gmail.com"
            },
        ...
        assert json.loads(response["body"])["message"] == "Token refreshed successfully"

    def test_refresh_token_missing_field_authorization(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
    ...
    def test_refresh_token_invalid_token(self):
        event = {
            ...
            "headers": {
                "header1": "value1",
                "header2": "value1,value2",
                'Authorization': "Bearer invalid_refresh_token-vitor@maua.br"
            },
            "queryStringParameters": {
                "parameter1": "value1,value2",
            },
