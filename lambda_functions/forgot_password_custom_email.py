    ...
    if event['userPoolId'] == USER_POOL_ID:
        ...
        if event['triggerSource'] == 'CustomMessage_ForgotPassword':
            ...
            <body style="font-family: Roboto; text-decoration: none; margin: 0; padding: 30px;">
                ...
                <br><br>
                <a id="botao-recuperar-senha" href="{FRONT_ENDPOINT}/#/login/esqueci-minha-senha?code={code}&email={email}&emailProvider={emailProvider}" style="font-family: Roboto; text-decoration: none; background-color: #004680; border-radius: 30px; color: #FFF; font-weight: 700; margin: 50px 0 0; padding: 20px;">Recuperar senha</a> 
                <br>
