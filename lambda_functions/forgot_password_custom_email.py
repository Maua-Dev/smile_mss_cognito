    ...
    if event['userPoolId'] == USER_POOL_ID:
        ...
        if event['triggerSource'] == 'CustomMessage_ForgotPassword':
            ...
            <body style="font-family: Roboto; text-decoration: none; margin: 0; padding: 30px;">
                <h1 id="titulo-email" style="font-family: Roboto; text-decoration: none; font-weight: 900; font-size: 10vw; margin: 0 0 10px;">Esqueceu a sua senha da Smile?</h1>
                <p id="corpo-email" style="font-family: Roboto; text-decoration: none; font-weight: 400; font-size: 5vw; margin: 0 0 50px;">É rápido! Você apenas precisa clicar no botão abaixo:</p>
        ...
        if event['triggerSource'] == 'CustomMessage_SignUp':
            ...
            Para confirmar seu cadastro na SMILE 2022 clique no botão: <br> <br> 

            <form action="{API_ENDPOINT}/confirmUserCreation" method="POST" target="_blank">
                <input type="hidden" id="login" name="login" value="{subId}">
