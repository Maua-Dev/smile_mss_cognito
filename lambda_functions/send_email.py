...
def lambda_handler(event, context):
    ...
    if event['triggerSource'] == 'CustomMessage_SignUp' or event['triggerSource'] == "CustomMessage_ResendCode":
        ...
        * {{
        ...
        <!--[if (mso)|(IE)]><td align="center" width="300" style="background-color: #223166;width: 300px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
        ...
        <a href="https://d3ebnpochj0915.cloudfront.net/logo-footer-smile-2023.png" target="_blank">
        ...
        <img align="center" border="0" src="https://d3ebnpochj0915.cloudfront.net/logo_maua_branco.png" alt="Logo Maua" title="Logo Maua" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 280px;" width="280"/>
        ...
        <!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #223166;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
        ...
        <h1 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; "><strong>Confirmação de cadastro SMILE 2023</strong></h1>
        ...
        <p style="line-height: 140%;">Falta só mais um passo para você se cadastrar na SMILE 2023!</p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">Para confirmar seu cadastro na SMILE 2023 clique:</p>
        </div>
        ...
        <span style="display:block;padding:10px 20px;line-height:120%;">Confirmar inscrição!</span>
        </a>
